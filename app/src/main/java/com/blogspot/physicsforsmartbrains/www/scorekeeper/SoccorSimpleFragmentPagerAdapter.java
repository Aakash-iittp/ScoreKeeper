...
public class SoccorSimpleFragmentPagerAdapter extends FragmentPagerAdapter {
    private String tabTitles[] = new String[] { "Rules", "Play", "Timer" };
    private Context context;

    public SoccorSimpleFragmentPagerAdapter(FragmentManager fm) {
        super(fm);
    }
